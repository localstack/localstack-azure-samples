...
This directory includes Bash scripts designed for deploying and testing the sample function app utilizing the `lstk` CLI. For further details about the sample application, refer to the [Azure Functions App with Service Bus Messaging](../README.md).
