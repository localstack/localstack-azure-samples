...
This directory contains Terraform modules and a deployment script for provisioning Azure services in LocalStack for Azure. For further details about the sample application, refer to the [Azure Functions App with Service Bus Messaging](../README.md).
...
8. [Azure App Service Plan](https://learn.microsoft.com/en-us/azure/app-service/overview-hosting-plans): Defines the underlying compute tier and scaling behavior for the function app.
...
- Packages the code of the function app into a zip file for deployment.
...
```bash
cd samples/function-app-service-bus/dotnet/terraform
```
