...
7. [Azure App Service Plan](https://learn.microsoft.com/en-us/azure/app-service/overview-hosting-plans): Defines the underlying compute tier and scaling behavior for the function app.
