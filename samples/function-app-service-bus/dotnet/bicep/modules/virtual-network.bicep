...
resource functionAppSubnetNsg 'Microsoft.Network/networkSecurityGroups@2025-05-01' = {
  name: functionAppSubnetNsgName
  location: location
  tags: tags
  properties: {
    securityRules: [
...
resource functionAppSubnetNsgDiagnosticSettings 'Microsoft.Insights/diagnosticSettings@2021-05-01-preview' = if (!empty(workspaceId)) {
  name: diagnosticSettingsName
  scope: functionAppSubnetNsg
  properties: {
    workspaceId: workspaceId
    logs: nsgLogs
  }
